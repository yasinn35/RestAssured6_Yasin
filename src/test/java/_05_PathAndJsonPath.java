...
public class _05_PathAndJsonPath {
    ...
    public void getZipCode(){
        ...
        Location locationPath=response.as(Location.class); // Bütün classları yazmak zorundasın
        System.out.println("locationPath.getPlaces() = " + locationPath.getPlaces());

        List<Place> places=response.jsonPath().getList("places", Place.class);
        System.out.println("places = " + places); // nokta atışı istdiğimizi aldık
